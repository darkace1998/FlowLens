...
| Insecure Protocol Detector | Identifies usage of well-known unencrypted protocols (like FTP, Telnet, HTTP, POP3, IMAP) to encourage migration to secure alternatives |
