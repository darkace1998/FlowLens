...
func TestDNSTunnelingDetector(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantAlerts: 1,
			wantTitle:  "DNS Tunneling Activity: 192.168.1.200",
		},
		{
			...
			flows: []model.Flow{
				{
					...
					DstPort:   53,
					Bytes:     600000, // > 500KB
					Packets:   10000,  // avg 60 bytes/packet
				},
			},
			wantAlerts: 0,
		},
...
func TestDNSTunnelingDetector_Error(t *testing.T) {
...
func TestDNSTunnelingDetector_EmptyFlows(t *testing.T) {
