...
func TestReadUintN(t *testing.T) {
	tests := []struct {
		...
		// Non-standard lengths (3, 5, 6, 7 bytes) — used by some exporters.
		{[]byte{0x01, 0x00, 0x00}, 65536},
		{[]byte{0x00, 0x0F, 0x42, 0x40, 0x00}, 0x0F424000},
		{[]byte{0x00, 0x00, 0x00, 0x0F, 0x42, 0x40}, 0x0F4240},
		{[]byte{0x00, 0x00, 0x00, 0x00, 0x0F, 0x42, 0x40}, 0x0F4240},
